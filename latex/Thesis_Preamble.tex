...
% Spacing
\setlength{\parskip}{0pt} % Adjusts space between paragraphs
\setlength{\parindent}{15pt} % Sets paragraph indentation
\raggedbottom % elimintes spaces between sections and figures
% Acronyms
\usepackage{etoolbox}
\makeatletter
\newif\if@in@acrolist

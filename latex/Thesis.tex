...
\NewDocumentCommand{\anote}{}{\makebox[0pt][l]{$^*$}} % Single asterisk
\NewDocumentCommand{\bnote}{}{\makebox[0pt][l]{$^{**}$}} % Double asterisks
...
\input{Thesis_Discussion} % file "Thesis_Discussion.tex"
\cleardoublepage

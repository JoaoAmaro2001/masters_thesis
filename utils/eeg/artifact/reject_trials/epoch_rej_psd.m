% For my own project, I wrote the following solution for bad trial rejection for pre-selected ICs. 
% This uses rectangular window short-term Fourier Transform (STFT) to convert 1 epoch into 1 PSD time point. 
% Then, it takes sum of power for the user-specified frequency band. 
% Then they are converted into z-score, and finally threshold it with SD. 
% The example code rejects epochs that have > 3SD power between 15-50 Hz.
%
% Example:
